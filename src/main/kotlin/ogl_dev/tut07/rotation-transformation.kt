...
fun main(args: Array<String>) {
    ...
    window = GlfwWindow(300, "Tutorial 7") // Create the window
...
var worldLocation = 0
val vsFileName = "tut07/shader.vert"
val fsFileName = "tut07/shader.frag"
var scale = 0.0f
...
fun renderScene() {
    ...
    world[0][0] = cos(scale); world[0][1] = -sin(scale); world[0][2] = 0.0f; world[0][3] = sin(scale)
    world[1][0] = sin(scale); world[1][1] = cos(scale); world[1][2] = 0.0f; world[1][3] = 0.0f

...
public class Tutorial06 implements GLEventListener {
    ...
    private final String SHADERS_ROOT = "src/ogldevtutorials/tut06_translationTransformation/shaders";
    ...
    private int programName, worldLocation;
    ...
    private void compileShaders(GL3 gl3) {
        ...
        worldLocation = gl3.glGetUniformLocation(programName, "world");
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        world.m00 = 1.0f; world.m01 = 0.0f; world.m02 = 0.0f; world.m03 = (float) Math.sin(scale);

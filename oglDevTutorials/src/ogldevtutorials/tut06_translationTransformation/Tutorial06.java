 ...
 */
package ogldevtutorials.tut06_translationTransformation;
...
import jglm.Mat4;
import ogldevtutorials.tut06_translationTransformation.glsl.Program;

/**
 *
 * @author elect
 */
public class Tutorial06 implements GLEventListener {

    public static void main(String[] args) {

        final Tutorial06 tutorial06 = new Tutorial06();

        final Frame frame = new Frame("Tutorial 06");

        frame.add(tutorial06.getNewtCanvasAWT());

        frame.setSize(tutorial06.getGlWindow().getWidth(), tutorial06.getGlWindow().getHeight());
        ...
        frame.addWindowListener(new WindowAdapter() {
            ...
            public void windowClosing(WindowEvent windowEvent) {
                tutorial06.getGlWindow().destroy();
                frame.dispose();
                System.exit(0);
            }
        });        
    ...
    public void init(GLAutoDrawable glad) {
        ...
        program = new Program(gl3, "/ogldevtutorials/tut06_translationTransformation/glsl/shaders/", "VS.glsl", "FS.glsl");
...
//        System.out.println("display");
        ...
        program.bind(gl3);
        {
            ...
            gWorld.c3.x = (float) Math.sin(scale);

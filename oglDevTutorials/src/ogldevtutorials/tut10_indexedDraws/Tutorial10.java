...
public class Tutorial10 implements GLEventListener {
    ...
    private final String SHADERS_ROOT = "src/ogldevtutorials/tut10_indexedDraws/shaders";
    ...
    private void createIndexBuffer(GL3 gl3) {
        ...
        gl3.glBufferData(GL_ELEMENT_ARRAY_BUFFER, indexBuffer.capacity() * Integer.BYTES, indexBuffer, GL_STATIC_DRAW);
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        world.m00 = (float) Math.cos(scale); world.m01 = 0.0f; world.m02 = -(float) Math.sin(scale); world.m03 = 0.0f;
        world.m10 = 0.0f; world.m11 = 1.0f; world.m12 = 0.0f; world.m13 = 0.0f;
        world.m20 = (float) Math.sin(scale); world.m21 = 0.0f; world.m22 = (float) Math.cos(scale); world.m23 = 0.0f;
        ...
        gl3.glDrawElements(GL_TRIANGLES, 12, GL_UNSIGNED_INT, 0);

 ...
 */
package ogldevtutorials.tutorial05;
...
import ogldevtutorials.tutorial05.glsl.Program;
...
public class Tutorial05 implements GLEventListener {
    ...
    public static void main(String[] args) {
        ...
        final Tutorial05 tutorial05 = new Tutorial05();

        final Frame frame = new Frame("Tutorial 05");

        frame.add(tutorial05.getNewtCanvasAWT());

        frame.setSize(tutorial05.getGlWindow().getWidth(), tutorial05.getGlWindow().getHeight());

 ...
 */
package ogldevtutorials.tutorial20;

import ogldevtutorials.tutorial20.util.Light;
...
import jglm.Vec3;
import jglm.Vec4;
import ogldevtutorials.tutorial20.glsl.LightingTechnique;
import ogldevtutorials.tutorial20.util.KeyListener;
...
public class Viewer implements GLEventListener {
    ...
    public Viewer() {
        ...
        directionalLight = new Light.DirectionalLight(new Vec3(1f, 1f, 1f), 0f, .01f, new Vec3(1f, 0f, 0f));

 ...
 */
package ogldevtutorials.tut07_rotationTransformation;
...
import jglm.Mat4;
import ogldevtutorials.tut07_rotationTransformation.glsl.Program;

/**
 *
 * @author elect
 */
public class Tutorial07 implements GLEventListener {

    public static void main(String[] args) {

        final Tutorial07 tutorial07 = new Tutorial07();

        final Frame frame = new Frame("Tutorial 07");

        frame.add(tutorial07.getNewtCanvasAWT());

        frame.setSize(tutorial07.getGlWindow().getWidth(), tutorial07.getGlWindow().getHeight());
        ...
        frame.addWindowListener(new WindowAdapter() {
            ...
            public void windowClosing(WindowEvent windowEvent) {
                tutorial07.getGlWindow().destroy();
                frame.dispose();
                System.exit(0);
            }
        });
...
//        System.out.println("display");
        ...
        program.bind(gl3);
        {
            ...
            gWorld.c0.y = (float) Math.sin(scale);
            gWorld.c1.x = -(float) Math.sin(scale);
            gWorld.c1.y = (float) Math.cos(scale);

 ...
 */
package ogldevtutorials.tutorial09;
...
import jglm.Mat4;
import ogldevtutorials.tutorial09.glsl.Program;
...
public class Tutorial09 implements GLEventListener {
    ...
    public static void main(String[] args) {
        ...
        final Tutorial09 tutorial09 = new Tutorial09();

        final Frame frame = new Frame("Tutorial 09");

        frame.add(tutorial09.getNewtCanvasAWT());

        frame.setSize(tutorial09.getGlWindow().getWidth(), tutorial09.getGlWindow().getHeight());
        ...
        frame.addWindowListener(new WindowAdapter() {
            ...
            public void windowClosing(WindowEvent windowEvent) {
                tutorial09.getGlWindow().destroy();
                frame.dispose();
                System.exit(0);
            }
        });
    ...
    public void init(GLAutoDrawable glad) {
        ...
        program = new Program(gl3, "/ogldevtutorials/tutorial09/glsl/shaders/", "VS.glsl", "FS.glsl");
